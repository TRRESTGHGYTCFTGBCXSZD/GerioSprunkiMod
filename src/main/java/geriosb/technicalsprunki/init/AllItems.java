...
public class AllItems {
    ...
    public static final RegistryObject<Item> FUN_BOT_SPAWNER = REGISTRY.register("fun_bot_spawner", () -> new ForgeSpawnEggItem(Sprunkis.FUN_BOT, -40704, -21159, new Item.Properties()));
